...
<head>
  ...
  <link rel="stylesheet" href="professor-more.css">
...
<body class="more-bg">
  ...
  <div class="sidenav" id="sideNav">
    <ul>
      ...
      <li><a class="active" href="professor-more.php"><span class="icon"><?php include 'icons/more.svg'; ?></span> More</a></li>
    </ul>
  </div>
  ...
  <div class="more-main">
    ...
    <div class="more-card"><a href="professorlogin.php?logout=1" class="more-link">Log out</a></div>
  </div>
